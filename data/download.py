...
def download_and_extract(directory, url):
  ...
  tar_filepath = "D:\\deep_speech\\librispeech_data\\" + str.split(tar_filepath,"\\")[-1] ## xy code
  print(tar_filepath)
...
def define_data_download_flags():
  ...
  absl_flags.DEFINE_string(
      ...
      "data_dir", "D:/deep_speech/librispeech_data",
...
directory = 'D:/deep_speech/librispeech_data/'
# dataset_dir = 'D:/deep_speech/librispeech_data/train-clean-100/'